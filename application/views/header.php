                ...
                <div class="container-fluid"><a class="navbar-brand" href="#" style="width: 78px;height: 60px;background: url(&quot;<?php echo base_url('assets/img/kisspng-freihandelsabkommen-treaty-north-american-free-tra-5b4c60db6f9f03.1069406315317321874572.png'); ?>&quot;) center / cover no-repeat;"></a><button style="background-color: white;" data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1" style="font-family: Montserrat, sans-serif;">
                        <ul class="navbar-nav mx-auto">
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('index.php/HomeCL/allProposition'); ?>" style="font-weight: bold;color: rgba(254,247,247,0.9);"><i class="fas fa-comments"></i>&nbsp; &nbsp;Les proposition</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('index.php/HomeCL/index'); ?>" style="font-family: Montserrat, sans-serif;font-weight: bold;color: rgba(255,255,255,0.55);"><i class="fas fa-home"></i>&nbsp; Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('index.php/HomeCL/newItem'); ?>" style="font-family: Montserrat, sans-serif;font-weight: bold;color: rgba(255,255,255,0.55);"><i class="fas fa-plus"></i>&nbsp; Nouvelle Contenue</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" style="font-family: Montserrat, sans-serif;font-weight: bold;color: rgba(255,255,255,0.55);"><i class="fab fa-searchengin"></i>&nbsp; Recherche</a></li>
                        </ul>
